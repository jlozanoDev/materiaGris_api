...
| **Informe** | Documento clínico digital generado a partir de una plantilla. Contiene los datos estructurados de una consulta o episodio médico. Sigue un ciclo de vida: borrador → firmado → archivado. |
...
| **Archivado de Informe** | Acción de archivar un informe firmado, que genera automáticamente el PDF final y cambia su estado a `archived`. Una vez archivado, solo está disponible para descarga. |
