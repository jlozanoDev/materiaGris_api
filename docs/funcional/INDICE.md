...
| Informes de pacientes | [`modulos/informes.md`](./modulos/informes.md) | CRUD de informes: crear, editar, firmar, archivar, descargar PDF |
...
| Gestión de informes | [`flujos/gestion-informes.md`](./flujos/gestion-informes.md) | Flujo completo: crear, editar, firmar, archivar y descargar informes |
