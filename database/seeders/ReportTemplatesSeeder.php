...
class ReportTemplatesSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ($templates as $template) {
            $structure = $this->replaceUuids($template['structure']);
    ...
    private function replaceUuids(array $data): array
    {
        foreach ($data as $key => &$value) {
            if ($key === 'id' && is_string($value) && str_starts_with($value, 'uuid-')) {
    ...
    private function hcgTemplate(): array
    {
        return [
                                        ...
                                        [
                                            ...
                                            'fields' => [
                                                ...
                                                [
                                                    ...
                                                    'required' => false,
                                                    'showLabel' => false,
                                                    'text_content' => 'Domicilio: {paciente.direccion}',
                                                ],
                                            ],
                                        ],
                                    ],
    ...
    private function iaTemplate(): array
    {
        return [
                                        ...
                                        'fields' => [
                                            [
                                                ...
                                                'columns' => [
                                                    ...
                                                    ['key' => 'duracion', 'label' => 'Duración (días)', 'type' => 'number', 'required' => true],
                                                    ['key' => 'indicacion', 'label' => 'Indicación', 'type' => 'text', 'required' => false],
                                                ],
    ...
    private function ciTemplate(): array
    {
        return [
